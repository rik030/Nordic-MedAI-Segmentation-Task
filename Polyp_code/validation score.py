...
def save_results(ori_x, ori_y, y_pred, save_image_path):
    ...
    ori_x = np.concatenate([ori_x, ori_x, ori_x], axis=-1)'''
...
if __name__ == "__main__":
    ...
    """ Load the dataset """
    dataset_path = os.path.join("/content/drive/MyDrive/Medai/Unet/data", "test")
    ...
    for x, y in tqdm(zip(test_x, test_y), total=len(test_x)):
        ...
        """ Saving the images """
        save_image_path = f"/content/drive/MyDrive/Medai/Unet/result/{name}.jpg"
    ...
    df.to_csv("/content/drive/MyDrive/Medai/Unet/files/area.csv")