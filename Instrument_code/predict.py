...
def load_data(path1,path2):
    x = sorted(glob(os.path.join(path1, "image", "*.jpg")))
...
if __name__ == "__main__":
    ...
    with CustomObjectScope({'iou': iou, 'dice_coef': dice_coef, 'dice_loss': dice_loss}):
        model = tf.keras.models.load_model("/content/drive/MyDrive/UNet_LD/files/model.h5")

    """ Load the dataset """
    path1 = "/content/drive/MyDrive/UNet_LD/dataset/predict"
    ...
    for x, y in tqdm(zip(test_x, test_y), total=len(test_x)):
        ...
        """ Saving the images """
        save_image_path = f"/content/drive/MyDrive/UNet_LD/result2/{name}.jpg"
    ...
    df.to_csv("/content/drive/MyDrive/UNet_LD/files/score.csv")
